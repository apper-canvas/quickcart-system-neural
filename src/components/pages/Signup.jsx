...
function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background dark:bg-surface-900">
      <div className="w-full max-w-md space-y-8 p-8 bg-white dark:bg-surface-800 rounded-lg shadow-md">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-secondary dark:text-gray-100">Create Account</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Sign up for your account</p>
        </div>
